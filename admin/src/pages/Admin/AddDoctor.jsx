...
function AddDoctor() {
  ...
  const onSubmitHandler=async (event)=>{
    ...
    try {
      ...
      // api call to the backend to save the details to the database
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          <label htmlFor="doc-img">
            <img src={docImg? URL.createObjectURL(docImg) :assets.upload_area} alt="" className='cursor-pointer w-16 bg-gray-100 rounded-full'/>
          </label>
